...
//    }
    ...
    public void shouldReturnResultOfSum() {
        int result = out.sum(CORRECT_NUMBER_1_1, CORRECT_NUMBER_2_1);
    ...
    public void shouldReturnResultOfSubstraction() {
        int result = out.subtraction(CORRECT_NUMBER_1_1, CORRECT_NUMBER_2_1);
    ...
    public void shouldReturnResultOfMultiply() {
        int result = out.multiply(CORRECT_NUMBER_1_1, CORRECT_NUMBER_2_1);
  ...
  //      Assertions.assertTrue(result.contains(CORRECT_MULTI_2));
    ...
    public void shouldReturnResultOfDivide() {
        float result = out.divide(CORRECT_NUMBER_1_1, CORRECT_NUMBER_2_1);
